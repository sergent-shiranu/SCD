...
public class LivreAdapter extends BaseAdapter 
{
	...
	public LivreAdapter(Context context, List<ParseObject> listLivres)
	{
		...
		this.livresPanier = new ArrayList<String>();
	}
			...
			viewHolder.chb.setOnCheckedChangeListener(new OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) 
				{
					...
					else
					{
						...
						livresPanier.remove(livre.getObjectId());
					}
	...
	public void setLivresPanier(ArrayList<String> livresPanier) 
	{
		this.livresPanier = livresPanier;
	}
